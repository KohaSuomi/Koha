use utf8;
package Koha::Schema::Result::BorrowersStaff;
...
Koha::Schema::Result::BorrowersStaff
...
=head1 TABLE: C<borrowers_staff>

=cut

__PACKAGE__->table("borrowers_staff");
...
__PACKAGE__->add_unique_constraint("othernames_2", ["othernames"]);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4qY4yHj4esaEnY0Uoz2sVg

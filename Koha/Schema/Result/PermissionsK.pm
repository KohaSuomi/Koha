use utf8;
package Koha::Schema::Result::PermissionsK;
...
Koha::Schema::Result::PermissionsK
...
=head1 TABLE: C<permissions_ks>

=cut

__PACKAGE__->table("permissions_ks");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:JRwwTPr7nxaQlA0s4zyeFw

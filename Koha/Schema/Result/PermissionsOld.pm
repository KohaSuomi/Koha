use utf8;
package Koha::Schema::Result::PermissionsOld;
...
=head1 TABLE: C<permissions_old>

=cut

__PACKAGE__->table("permissions_old");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:vVWPrAlfsm/NlbzDdGTnWQ

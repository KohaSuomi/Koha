...
('autoBarcode','OFF','incremental|annual|hbyymmincr|EAN13|OFF|vaarakirjastot|hbyyyyincr','Used to autogenerate a barcode: incremental will be of the form 1, 2, 3; annual of the form 2007-0001, 2007-0002; hbyymmincr of the form HB08010001 where HB=Home Branch','Choice'),
...
('barcodeprefix', '', '', 'Defines the barcode prefixes when the autoBarcode value is set as hbyyyyincr', 'textarea'),
...
('ExpireReservesMaxPickUpDelay','0','','Enabling this allows holds to expire automatically if they have not been picked by within the time period specified in circulation rules','YesNo'),
...
('POSIntegration', '', '', 'Maps Koha account types into POS item numbers and defines the interfaces that will be used for each branch', 'textarea'),
...
('SSBlockCleanOlderThanThis','3650',NULL,'Clean expired self-service branch-specific access blocks older than this many days. You must enable access rule "BranchBlock" in syspref "SSRules" for this to have effect.','Integer'),
('SSBlockDefaultDuration','60','','Self-service branch-specific access block default duration in days, eg.<br/><pre>120</pre><br/>. You must enable access rule "BranchBlock" in syspref "SSRules" for this to have effect.','free'),
...
('VaaraAcqVendorConfigurations','','70|10','Define vendor integration rules:','Textarea'),

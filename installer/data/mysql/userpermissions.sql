INSERT INTO permissions (module, code, description) VALUES
   ...
   ( 'editcatalogue',   'add_holding', 'Allows to create a new holding record'),
   ( 'editcatalogue',   'edit_holding', 'Allows to update a holding record'),
   ( 'editcatalogue',   'delete_holding', 'Allows to delete a holding record'),
